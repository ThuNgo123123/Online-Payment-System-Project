...
class BusinessHomeView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const BussinessHomePage();
  }
}

class BussinessHomePage extends StatefulWidget {
  const BussinessHomePage({super.key});

  @override
  State<BussinessHomePage> createState() => _BussinessHomePageState();
}

class _BussinessHomePageState extends State<BussinessHomePage> {
          ...
          content: SingleChildScrollView(
            child: ListBody(
              children: const <Widget>[
                Text(
                    'Hóa đơn #HD00001 đã được thanh toán thành công số tiền 21.380.000 ₫. Chuyển trạng thái hóa đơn sang hoàn thành'),
              ],
            ),
          ),
          actions: <Widget>[
