...
import 'package:god/src/presention/graber/qr_scanner_view.dart';

import '../loading/Loading_page.dart';

class GraberHomeView extends StatelessWidget {
  const GraberHomeView({super.key});

  @override
  Widget build(BuildContext context) {
    return const GraberHomePage();
  }
}

class GraberHomePage extends StatefulWidget {
  const GraberHomePage({super.key});

  @override
  State<GraberHomePage> createState() => _GraberHomePageState();
}

class _GraberHomePageState extends State<GraberHomePage> {
          ...
          IconButton(
            onPressed: () {
              Navigator.of(context).push(MaterialPageRoute(
                builder: (context) => const QRViewGraber(),
              ));
            },
            icon: const Icon(
              Icons.qr_code,
          ...
          content: SingleChildScrollView(
            child: ListBody(
              children: const <Widget>[
                Text(
                    'Hóa đơn #HD00001 đã được thanh toán thành công số tiền 00.000 ₫. Chuyển trạng thái hóa đơn sang hoàn thành'),
              ],
            ),
          ),
          actions: <Widget>[
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    child: const Padding(
                      ...
                      child: Text(
                        "Xác nhận đã nhận tiền mặt từ khách hàng",
